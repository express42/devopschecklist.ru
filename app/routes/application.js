    ...
    this.get('store').push({
      data: [
            {
                ...
                attributes: {
                  ...
                  description: 'Идея DevOps завязана на концепции согласованности. Эта идея появилась вследствие несовместимых приоритетов и стремлений команд разработки и эксплуатации.',
                  category: 'alignment',
                  checked: false,
                  tags: ['Культура']
                }
          ...
          },
          {
              ...
              type: 'check-item',
              attributes: {
                title: 'Мы выявляем навыки, необходимые для совершенствования и достижения будущих целей.',
                description: "",
                category: "learning",
                checked: false,
                tags: ["Культура", "Измерения"]
          ...
          },
          {
              ...
              attributes: {
                ...
                description: 'Деплои в продакшн все еще могут производиться вручную в случае, когда для этого требуется одобрение (signoff), однако тестирование, процесс разработки и валидации должны быть полностью автоматизированы для обеспечения непротиворечивости, точности и оптимальной скорости. Автоматизация деплоев означает отсутствие ручных действий, снижение рисков безопасности, повышение контролируемости процесса и уверенности в нем. ',
                category: "lifecycle",
                checked: false,
          ...
          },
          {
              ...
              attributes: {
                ...
                description: 'Для того чтобы избежать фрагментации и повторений лучше всего ограничить различия в окружениях лишь настройкой значений переменных.',
                category: "lifecycle",
                checked: false,
                tags: ["Автоматизация", "Тестирование"]
              }
          },
          {
              ...
              attributes: {
                ...
                description: 'Допустим, что тебе повезло, и ты оказался окружен экспертами.  В идеальном случае, они не представляют из себя просто острова знаний и ответственности, а являются частью группы наравне со всеми в рамках одной организации.',
          ...
          },
          {
              ...
              type: 'check-item',
              attributes: {
                title: 'Мы пересматриваем приоритеты на регулярной основе.',
                description: "",
                category: "organisation",
                checked: false,
                tags: ["Культура", "Шэринг"]
          ...
          },
          {
              ...
              attributes: {
                ...
                description: 'Фокус на обучении и постоянном совершенствовании. Это сродни фокусированию на MTTR vs MTBF, только применительно к человеку. Читайте: замечательная статья John Allspaw о процессах в Etsy',
                category: "process",
                checked: false,
                tags: ["Культура", "Шэринг"]
              }
          ...
          },
          {
              ...
              attributes: {
                ...
                description: 'Пока ты не докажешь, что твой код не вносит деструктивную регрессию, его не следует деплоить.  Автоматизированное тестирование и частые мерджи должны отлавливать большинство таких проблем с кодом. Сделай все, чтобы быть уверенным, что не узнаешь потом о проблеме от кого-то еще или, что еще хуже, из Twitter.',
                category: "process",
                checked: false,
                tags: ["Тестирование"]
              }
      ...
      included: [
        ...
        },
        {
          ...
          attributes: {
            title: 'Обучение',
            description: 'Предоставление возможностей личностного роста и стимулирование понимания через процесс постоянного совершенствования.',
          },
          relationships: {
            checkItems: {
              data: [
